...
var strings = {
    ...
    "about.shim": "Починати облік при відкритті книги",
    "about.shimHint": "Після ввімкнення рідера ніщо не запускається саме. З цим налаштуванням відкриття книги спершу запускає облік, а потім передає книгу звичайній читалці — для EPUB, FB2 і PDF.",
    "about.shimOn": "Увімкнути",
    "about.shimOff": "Вимкнути",
    "about.shimActive": "Увімкнено. Книги відкриваються як раніше, читалка не змінюється.",
    "about.shimInactive": "Вимкнено. Відкривайте застосунок після ввімкнення рідера, інакше день не запишеться.",
