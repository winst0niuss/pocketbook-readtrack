...
var strings = {
    ...
    "about.shim": "Начинать учёт при открытии книги",
    "about.shimHint": "После включения ридера ничего не запускается само. С этой настройкой открытие книги сначала запускает учёт, а потом передаёт книгу обычной читалке — для EPUB, FB2 и PDF.",
    "about.shimOn": "Включить",
    "about.shimOff": "Выключить",
    "about.shimActive": "Включено. Книги открываются как раньше, читалка не меняется.",
    "about.shimInactive": "Выключено. Открывайте приложение после включения ридера, иначе день не запишется.",
